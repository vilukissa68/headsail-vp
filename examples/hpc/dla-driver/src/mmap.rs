...
pub(crate) const DLA_SW_IRQ_BITMASK: usize = 0b100000000;
...
pub(crate) const DLA_READ_B_VALID_BITMASK: usize = 0b100000000;
...
pub(crate) const DLA_MAC_CLIP_BITMASK: usize = 0x1111100000000;
...
pub(crate) const DLA_PP_SELECT_BITMASK: usize = 0b1000000;
pub(crate) const DLA_POOL_MODE_BITMASK_UNUSED: usize = 0b110000000;
pub(crate) const DLA_ROUNDING_BITMASK: usize = 0b1000000000;
pub(crate) const DLA_CTRL_VLD_BITMASK_UNUSED: usize = 0b10000000000;
...
pub(crate) const DLA_BUF_PAD_RIGHT_BITMASK: usize = 0b11110000;
pub(crate) const DLA_BUF_PAD_BOTTOM_BITMASK: usize = 0b111100000000;
pub(crate) const DLA_BUF_PAD_LEFT_BITMASK: usize = 0b1111000000000000;
pub(crate) const DLA_BUF_PAD_VALUE_BITMASK: usize = 0b11110000000000000000;
...
pub(crate) const DLA_BUF_STRIDE_Y_BITMASK: usize = 0b11110000000000000000;
...
pub(crate) const DLA_PP_INPUT_HEIGHT_BITMASK: usize = 0b1111111110000000000000000;
...
pub(crate) const DLA_HANDSHAKE_MAC_VALID_BITMASK: usize = 0b10;
pub(crate) const DLA_HANDSHAKE_POOL_VALID_BITMASK: usize = 0b100;
pub(crate) const DLA_HANDSHAKE_ACTIVE_VALID_BITMASK: usize = 0b1000;
pub(crate) const DLA_HANDSHAKE_BUFFER_ENABLE_BITMASK: usize = 0b10000;
pub(crate) const DLA_HANDSHAKE_MAC_ENABLE_BITMASK: usize = 0b100000;
pub(crate) const DLA_HANDSHAKE_ACTIVE_ENABLE_BITMASK: usize = 0b1000000;
pub(crate) const DLA_HANDSHAKE_POOL_ENABLE_BITMASK: usize = 0b10000000;
pub(crate) const DLA_HANDSHAKE_BIAS_ENABLE_BITMASK: usize = 0b100000000;
pub(crate) const DLA_HANDSHAKE_BYPASS_ENABLE_BITMASK: usize = 0b1000000000;
